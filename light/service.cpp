...
const static std::string kRedScalingPath = "/sys/class/leds/red/scaling";
const static std::string kRedBlinkPath = "/sys/class/leds/red/blink";
const static std::string kGreenBlinkPath = "/sys/class/leds/red/blink";
const static std::string kBlueBlinkPath = "/sys/class/leds/red/blink";
...
int main() {
    ...
    std::ofstream redScaling(kRedScalingPath);
    if (!redScaling) {
        LOG(ERROR) << "Failed to open " << kRedScalingPath << ", error=" << errno
                   << " (" << strerror(errno) << ")";
        return -errno;
    }
    ...
    android::sp<ILight> service = new Light(
            ...
            std::move(redOnTime), std::move(redPeriod), std::move(redRampTime), std::move(redScaling),
